...
public class AIVDemoViewController: AUViewController {
    ...
    private func connectViewToAU() {
        ...
        guard let cutoff = paramTree.value(forKey: "eq1Freq") as? AUParameter,
            let resonance = paramTree.value(forKey: "eq1Q") as? AUParameter else {
...
extension AIVDemoViewController: FilterViewDelegate {
...
#if os(iOS)
extension AIVDemoViewController: UITextFieldDelegate {
