...
public class AIVDemo: AUAudioUnit {

    private let parameters: AIVDemoParameters
    private let kernelAdapter: AIVDSPKernelAdapter
    ...
    weak var viewController: AIVDemoViewController?
    ...
    public override init(componentDescription: AudioComponentDescription,
        ...
        kernelAdapter = AIVDSPKernelAdapter()
        
        // Create parameters object to control cutoff frequency and resonance
        parameters = AIVDemoParameters(kernelAdapter: kernelAdapter)
